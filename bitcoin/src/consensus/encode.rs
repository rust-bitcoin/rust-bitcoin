...
impl<W: Write + ?Sized> WriteExt for W {
    ...
    #[inline]
    fn emit_compact_size(&mut self, v: impl ToU64) -> Result<usize, io::Error> {
        let encoded = compact_size::encode(v.to_u64().try_into().unwrap_or(usize::MAX));
...
#[inline]
pub fn varint_size(v: impl ToU64) -> usize { encoding::compact_size::encoded_size_const(v.to_u64()) }
