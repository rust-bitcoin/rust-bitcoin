...
fn instruction_indices_nth_extended() {
    // Script bytes: OP_FALSE (00) | OP_PUSHBYTES_1 (01) 0x69 | OP_CSV (b2)
    // Instructions begin at byte positions: 0, 1, 3.
    let script = ScriptBuf::from_hex("000169b2").unwrap();
    ...
    assert_eq!(pos_2.1, Instruction::Op(OP_CSV), "nth(2) must be OP_CSV");
