   ...
   fn psbt_uncompressed_key() {
    ...
    mod bip_371_vectors {
        ...
        fn invalid_vectors() {
            ...
            assert_eq!(err.to_string(), "PSBT error: invalid xonly public key");
            ...
            assert_eq!(err.to_string(), "PSBT error: signature error - invalid Schnorr signature length");
            ...
            #[cfg(feature = "std")]
            assert_eq!(err.to_string(), "PSBT error: hash parse error");
            #[cfg(not(feature = "std"))]
            ...
            assert_eq!(err.to_string(), "PSBT error: invalid control block");
