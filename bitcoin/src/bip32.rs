...
impl Xpriv {
    ...
    pub fn derive_priv<P: AsRef<[ChildNumber]>>(&self, path: P) -> Result<Xpriv, DerivationError> {
    ...
    ///
    /// The `path` argument can be both of type `DerivationPath` or `Vec<ChildNumber>`.
    pub fn derive_xpriv<P: AsRef<[ChildNumber]>>(&self, path: P) -> Result<Xpriv, DerivationError> {
    ...
    fn ckd_priv(&self, i: ChildNumber) -> Result<Xpriv, DerivationError> {
...
impl Xpub {
    ...
    pub fn from_priv(sk: &Xpriv) -> Xpub { Self::from_xpriv(sk) }

    /// Constructs a new extended public key from an extended private key.
    pub fn from_xpriv(xpriv: &Xpriv) -> Xpub {
        Xpub {
    ...
    pub fn derive_pub<P: AsRef<[ChildNumber]>>(&self, path: P) -> Result<Xpub, DerivationError> {
    ...
    ///
    /// The `path` argument can be any type implementing `AsRef<ChildNumber>`, such as `DerivationPath`, for instance.
    pub fn derive_xpub<P: AsRef<[ChildNumber]>>(&self, path: P) -> Result<Xpub, DerivationError> {
    ...
    pub fn ckd_pub(&self, i: ChildNumber) -> Result<Xpub, DerivationError> {
