...
pub struct SegwitV0Signature(pub(crate) ecdsa::Signature);

impl SegwitV0Signature {
    /// Construct a segwit v0 ECDSA Bitcoin signature for [`EcdsaSighashType::All`].
    pub fn sighash_all(sig: secp256k1::ecdsa::Signature) -> SegwitV0Signature {
...
impl fmt::Display for SegwitV0Signature {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result { fmt::Display::fmt(&self.0, f) }
}

impl FromStr for SegwitV0Signature {
    type Err = Error;
