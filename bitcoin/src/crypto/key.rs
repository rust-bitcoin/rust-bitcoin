...
impl Keypair {
    ...
    #[inline]
    #[cfg(all(feature = "rand", feature = "std"))]
    pub fn sign_schnorr(&self, msg: &[u8]) -> secp256k1::schnorr::Signature { self.0.sign_schnorr(msg) }

    /// Constructs a schnorr signature without aux rand for `msg`.
    #[inline]
    pub fn sign_schnorr_no_aux_rand(&self, msg: &[u8]) -> secp256k1::schnorr::Signature {
        self.0.sign_schnorr_no_aux_rand(msg)
    }
