...
impl PublicKey {
    ...
    pub fn from_keypair(pair: &Keypair) -> Self {
        Self::new(secp256k1::PublicKey::from_keypair(pair.as_inner()))
    }
...
impl SortKey {
    /// Constructs a new sort key from an ArrayVec buffer.
    pub fn new(buf: ArrayVec<u8, 65>) -> Self { Self(buf) }
}
...
mod tests {
    ...
    fn pubkey_to_sort_key() {
        ...
        let expected1 = SortKey::new(arrayvec1);
        ...
        let expected2 = SortKey::new(arrayvec2);
