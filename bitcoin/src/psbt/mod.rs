...
mod tests {
    ...
    mod bip_373_vectors {
        ...
        const PARTICIPANT_1: &str =
            "02346b99593357107c9d3459e9deba8d3eaf44e6636c85c7f853eb90ba52e8cd00";
        const PARTICIPANT_2: &str =
            "024fafd65f8169186fc2bfdb2233c77e630d10be280a24c7165c09a27611775c2c";
        const PARTICIPANT_3: &str =
            "02f9308a019258c31049344f85f89d5229b531c845836f99b08601f113bce036f9";
        const AGGREGATE_KEY: &str =
            "030b58e337aa4d3852a8c29387c42408d8cfbe3a613a5e397e0a9f01a5fb7107d4";

        fn pk(hex: &str) -> secp256k1::PublicKey { secp256k1::PublicKey::from_str(hex).unwrap() }

        #[test]
        fn valid_psbt_vectors() {
            let agg = pk(AGGREGATE_KEY);
            let participants = vec![pk(PARTICIPANT_1), pk(PARTICIPANT_2), pk(PARTICIPANT_3)];
            // Case: Output key spend - participant pubkeys only
            let psbt = hex_psbt("").unwrap();
            let input = &psbt.inputs[0];
            assert_eq!(input.musig2_participant_pubkeys[&agg], participants);
            assert!(input.tap_internal_key.is_none());
            assert!(input.tap_scripts.is_empty());
            assert!(input.musig2_pub_nonces.is_empty());
            assert!(input.musig2_partial_sigs.is_empty());

            // Case: Output key spend - with all pubnonces
            let psbt = hex_psbt("").unwrap();
            let input = &psbt.inputs[0];
            assert_eq!(input.musig2_participant_pubkeys[&agg], participants);
            assert!(input.tap_internal_key.is_none());
            assert_eq!(input.musig2_pub_nonces.len(), 3);
            assert!(input
                .musig2_pub_nonces
                .keys()
                .all(|(_, agg_pk, leaf)| *agg_pk == agg && leaf.is_none()));
            assert!(input.musig2_partial_sigs.is_empty());

            // Case: Output key spend - with all partial signatures
            let psbt = hex_psbt("").unwrap();
            let input = &psbt.inputs[0];
            assert_eq!(input.musig2_participant_pubkeys[&agg], participants);
            assert!(input.tap_internal_key.is_none());
            assert_eq!(input.musig2_pub_nonces.len(), 3);
            assert_eq!(input.musig2_partial_sigs.len(), 3);
            assert!(input
                .musig2_partial_sigs
                .keys()
                .all(|(_, agg_pk, leaf)| *agg_pk == agg && leaf.is_none()));

            // Case: Internal key spend - participant pubkeys only
            let psbt = hex_psbt("").unwrap();
            let input = &psbt.inputs[0];
            ...
            // Case: Internal key spend - with all pubnonces
            let psbt = hex_psbt("").unwrap();
            let input = &psbt.inputs[0];
            assert!(input.tap_internal_key.is_some());
            assert_eq!(input.musig2_participant_pubkeys[&agg], participants);
            assert_eq!(input.musig2_pub_nonces.len(), 3);
            assert!(input.musig2_pub_nonces.keys().all(|(_, _, leaf)| leaf.is_none()));
            assert!(input.musig2_partial_sigs.is_empty());

            // Case: Internal key spend - with all partial signatures
            let psbt = hex_psbt("").unwrap();
            let input = &psbt.inputs[0];
            assert!(input.tap_internal_key.is_some());
            assert_eq!(input.musig2_participant_pubkeys[&agg], participants);
            assert_eq!(input.musig2_pub_nonces.len(), 3);
            assert_eq!(input.musig2_partial_sigs.len(), 3);
            assert!(input.musig2_partial_sigs.keys().all(|(_, _, leaf)| leaf.is_none()));
            assert!(input.tap_key_sig.is_some());

            // Case: Script key spend - participant pubkeys only
            let psbt = hex_psbt("").unwrap();
            let input = &psbt.inputs[0];
            assert!(!input.tap_scripts.is_empty());
            assert_eq!(input.musig2_participant_pubkeys[&agg], participants);
            assert!(input.musig2_pub_nonces.is_empty());
            ...
            // Case: Script key spend - with all pubnonces
            let psbt = hex_psbt("").unwrap();
            let input = &psbt.inputs[0];
            assert!(!input.tap_scripts.is_empty());
            assert_eq!(input.musig2_participant_pubkeys[&agg], participants);
            assert_eq!(input.musig2_pub_nonces.len(), 3);
            assert!(input
                .musig2_pub_nonces
                .keys()
                .all(|(_, agg_pk, leaf)| *agg_pk == agg && leaf.is_some()));
            assert!(input.musig2_partial_sigs.is_empty());

            // Case: Script key spend - with all partial signatures
            let psbt = hex_psbt("").unwrap();
            let input = &psbt.inputs[0];
            assert!(!input.tap_scripts.is_empty());
            assert_eq!(input.musig2_participant_pubkeys[&agg], participants);
            assert_eq!(input.musig2_pub_nonces.len(), 3);
            ...
            // Case: Derived internal key spend - participant pubkeys only
            let psbt = hex_psbt("").unwrap();
            let input = &psbt.inputs[0];
            assert!(input.tap_internal_key.is_some());
            assert_eq!(input.musig2_participant_pubkeys[&agg], participants);
            assert!(input.tap_scripts.is_empty());
            ...
            // Case: Derived internal key spend - with all pubnonces
            let psbt = hex_psbt("").unwrap();
            let input = &psbt.inputs[0];
            assert!(input.tap_internal_key.is_some());
            assert_eq!(input.musig2_participant_pubkeys[&agg], participants);
            assert_eq!(input.musig2_pub_nonces.len(), 3);
            ...
            // Case: Derived internal key spend - with all partial signatures
            let psbt = hex_psbt("").unwrap();
            let input = &psbt.inputs[0];
            assert!(input.tap_internal_key.is_some());
            assert_eq!(input.musig2_participant_pubkeys[&agg], participants);
            assert_eq!(input.musig2_pub_nonces.len(), 3);
            ...
            // Case: Receiving output - internal key is MuSig2 aggregate
            let psbt = hex_psbt("").unwrap();
            let output = &psbt.outputs[0];
            assert!(output.tap_internal_key.is_some());
            assert_eq!(output.musig2_participant_pubkeys[&agg], participants);

            // Case: Receiving output - derived from MuSig2 aggregate
            let psbt = hex_psbt("").unwrap();
            let output = &psbt.outputs[0];
            assert!(output.tap_internal_key.is_some());
            assert_eq!(output.musig2_participant_pubkeys[&agg], participants);
        }
        ...
        #[test]
        fn invalid_psbt_vectors() {
            // x-only aggregate pubkey in input participant pubkeys keydata
            hex_psbt("").unwrap_err();

            // x-only input participant pubkey
            hex_psbt("").unwrap_err();

            // x-only aggregate pubkey in output participant pubkeys keydata
            hex_psbt("").unwrap_err();

            // x-only output participant pubkey
            // NOTE: This vector is identical to the previous one in the BIP source.
            hex_psbt("").unwrap_err();

            // x-only aggregate pubkey in public nonce keydata
            hex_psbt("").unwrap_err();

            // x-only participant pubkey in public nonce keydata
            hex_psbt("").unwrap_err();

            // Invalid public nonce valuedata length
            hex_psbt("").unwrap_err();

            // x-only aggregate pubkey in partial sig keydata
            hex_psbt("").unwrap_err();

            // x-only participant pubkey in partial sig keydata
            hex_psbt("").unwrap_err();

            // Invalid partial sig valuedata length
            hex_psbt("").unwrap_err();
        }
    }
