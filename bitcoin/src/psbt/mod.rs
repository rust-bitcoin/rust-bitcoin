...
mod tests {
    ...
    mod bip_vectors {
        ...
        macro_rules! test_invalid_vector_case {
            (
                $vector_num:ident;
                $hex:literal;
                $base64:literal;
                ...
                mod $vector_num {
                    ...
                    fn invalid_vector() {
                        super::hex_psbt($hex).unwrap();
                    }

                    #[cfg(feature = "base64")]
                    #[test]
                    #[should_panic(expected = $err)]
                    fn invalid_vector_base64() {
                        $base64.parse::<crate::Psbt>().unwrap();
                    }
                }
            };
        }
        ...
        test_invalid_vector_case!(
            ...
            "DuplicateKey(Key { type_value: 0, key_data: [] })";
        );
        ...
        test_invalid_vector_case!(
            ...
            "InvalidKey(Key { type_value: 0, key_data: [1] })";
        );
        ...
        test_invalid_vector_case!(
            ...
            "InvalidKey(Key { type_value: 1, key_data: [0] })";
        );
        ...
        test_invalid_vector_case!(
            ...
            "InvalidPublicKey(InvalidLength(32))";
        );
        ...
        test_invalid_vector_case!(
            ...
            "InvalidKey(Key { type_value: 4, key_data: [0] })";
        );
        ...
        test_invalid_vector_case!(
            ...
            "InvalidKey(Key { type_value: 5, key_data: [0] })";
        );
        ...
        test_invalid_vector_case!(
            ...
            "InvalidSecp256k1PublicKey(InvalidPublicKey)";
        );
        ...
        test_invalid_vector_case!(
            ...
            "InvalidKey(Key { type_value: 0, key_data: [0] })";
        );
        ...
        test_invalid_vector_case!(
            ...
            "InvalidKey(Key { type_value: 7, key_data: [0] })";
        );
        ...
        test_invalid_vector_case!(
            ...
            "InvalidKey(Key { type_value: 8, key_data: [0] })";
        );
        ...
        test_invalid_vector_case!(
            ...
            "InvalidKey(Key { type_value: 3, key_data: [0] })";
        );
        ...
        test_invalid_vector_case!(
            ...
            "InvalidKey(Key { type_value: 1, key_data: [0, 37, 81, 33, 3, 183, 206, 35, 160, 28, 91, 75, 240, 10, 100, 37, 55, 205, 250, 187, 49, 91, 102, 131, 50, 134, 116, 120, 239, 81, 48, 157] })";
        );
