...
impl Params {
    ...
    pub const fn new(network: Network) -> Self {
        match network {
            ...
            Network::Testnet(_) => panic!("unreachable in network 0.1.0"),
...
impl From<Network> for &'static Params {
    fn from(value: Network) -> Self { crate::network::params(value) }
}
...
impl AsRef<Params> for Network {
    fn as_ref(&self) -> &Params { crate::network::params(*self) }
}
