...
use bitcoin::{Network, NetworkKind, PublicKey};
...
fn main() {
    ...
    let root = Xpriv::new_master(NetworkKind::Real, &seed).unwrap();
    ...
    let address = Address::p2wpkh(&PublicKey::new(public_key), Network::Bitcoin).unwrap();
