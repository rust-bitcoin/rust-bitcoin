...
fn main() {
    ...
    let script_code = dummy_utxo.script_pubkey.p2wpkh_script_code().expect("p2wpkh script pubkey");
    ...
    sighasher.witness_mut(input_index).unwrap().push_segwit_v0_signature(&sig);
