...
use primitives::hashes::{hash160, hash_newtype, sha512, Hash, HashEngine, Hmac, HmacEngine};
use primitives::io::Write;
use primitives::secp256k1::{self, Secp256k1, XOnlyPublicKey};
use primitives::{base58, hex, CompressedPublicKey, Keypair, NetworkKind, PrivateKey};
...
#[cfg(test)]
mod tests {
    use primitives::hex::test_hex_unwrap as hex;
