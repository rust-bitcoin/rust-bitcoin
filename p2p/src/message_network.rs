...
type VersionMessageDecoderFirst6 = encoding::Decoder6<
...
type VersionMessageDecoderLast3 =
    encoding::Decoder3<UserAgentDecoder, encoding::ArrayDecoder<4>, encoding::ArrayDecoder<1>>;

type VersionMessageInnerDecoder =
    encoding::Decoder2<VersionMessageDecoderFirst6, VersionMessageDecoderLast3>;
