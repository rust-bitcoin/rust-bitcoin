...
use bitcoin::{Address, Amount, Network, OutPoint, PublicKey, PrivateKey, Script, Transaction, Txid, TxOut, TxIn, Witness};
...
mod psbt_sign {
    ...
    fn prevouts<'a>(psbt: &Psbt) -> Result<Vec<&TxOut>, SighashError> {
