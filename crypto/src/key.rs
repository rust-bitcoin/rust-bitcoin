...
use hashes::hash160;
use hex_unstable::{FromHex, DisplayHex, HexToArrayError};
...
impl PublicKey {
    ...
    ///
    /// ```rust
    /// use bitcoin_crypto::key::PublicKey;
    ///
    ...
    /// [`FromSliceError::InvalidKeyPrefix`] if the key is not compressed and the prefix is
    /// invalid.
