...
mod tests {
    ...
    mod bip_vectors {
        ...
        fn invalid_vector_1() {
            ...
            #[cfg(feature = "base64")] {
                let psbt2 = PartiallySignedTransaction::from_str("");
                assert!(psbt2.is_err());
            }
        }
        ...
        fn invalid_vector_4() {
            ...
            #[cfg(feature = "base64")] {
                let psbt2 = PartiallySignedTransaction::from_str("");
                assert!(psbt2.is_err());
            }
        }
