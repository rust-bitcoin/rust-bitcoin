...
//! mnemonic in english
//!
use hashes::core::fmt::{Display, Formatter};
use hashes::{sha256, sha512, Hash, HashEngine, Hmac, HmacEngine};
use secp256k1::rand::{thread_rng, RngCore};
use std::io::Cursor;
use util::bip158::{BitStreamReader, BitStreamWriter};
...
impl Mnemonic {
    ...
    /// Iterator over the words of this mnemonic
    ...
    /// Try to extend a 12 words mnemonic to a 24 words mnemonic
