        ...
        where D: serde::Deserializer
    {
        ...
        impl serde::de::Visitor for ScriptVisitor {
            ...
            fn visit_str<E>(&mut self, hex_str: &str) -> Result<Script, E>
                where E: serde::de::Error
            {
                let raw_vec: Vec<u8> = try!(decode(hex_str)
...
mod test {
    ...
    fn script_builder() {
        ...
        let script = Builder::new().push_opcode(opcodes::All::OP_DUP)
                                   ...
                                   .push_slice(&decode("16e1ae70ff0fa102905d4af297f6912bda6cce19").unwrap())
    ...
    #[test]
    fn script_serialize() {
        let hex_script = decode("6c493046022100f93bb0e7d8db7bd46e40132d1f8242026e045f03a0efe71bbb8e3f475e970d790221009337cd7f1f929f00cc6ff01f03729b069a7c21b59b1736ddfee5db5946c5da8c0121033b9b137ee87d5a812d6f506efdd37f0affa7ffc310711c06c7f3e097c9447c52").unwrap();
	...
	fn test_bitcoinconsensus () {
		...
		let spent = Builder::from(decode("0020701a8d401c84fb13e6baf169d59684e17abd9fa216c8cc5b9fc63d622ff8c58d").unwrap()).into_script();
		let spending = decode("").unwrap();
