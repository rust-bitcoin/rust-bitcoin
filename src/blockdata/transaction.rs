...
mod tests {
    ...
    fn test_transaction_verify() {
        ...
        let mut spending: Transaction = deserialize(hex::decode("")
            .unwrap().as_slice()).unwrap();
        let spent1: Transaction = deserialize(hex::decode("")
            .unwrap().as_slice()).unwrap();
        let spent2: Transaction = deserialize(hex::decode("")
            .unwrap().as_slice()).unwrap();
        let spent3: Transaction = deserialize(hex::decode("")
            .unwrap().as_slice()).unwrap();
