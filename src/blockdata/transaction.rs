...
use hash_types::{Txid, Wtxid, SigHash};
...
impl Transaction {
    ...
    pub fn get_fee<R>(&self, tx_resolver: R) -> Result<Amount, Error>
        where R: Fn(&OutPoint) -> Result<u64, Error> {

        let mut sum_in: u64 = 0;
        for input in &self.input {
            sum_in += tx_resolver(&input.previous_output)?;
        }
        ...
        if sum_in < sum_out {
            ...
            Ok(Amount::from_sat(sum_in - sum_out))
        }
    }
...
mod tests {
    ...
    use super::{OutPoint, ParseOutPointError, Transaction, TxIn, Error};
    ...
    #[test]
    fn test_getfee() {
        let tx: Transaction = deserialize(Vec::from_hex("").unwrap().as_slice()).unwrap();

        let txmap = vec![
            "",
            "",
            "",
            "",
            ""
        ].iter().map(|raw| {
            let tx: Transaction = deserialize((Vec::from_hex(raw).unwrap().as_slice())).unwrap();
            (tx.txid(), tx)
        }).collect::<HashMap<Txid, Transaction>>();

        let fee = Amount::from_sat(37319);

        let get_fee_result = tx.get_fee(|out_point| {
            txmap.get(&out_point.txid)
                .map(|tx| tx.output[out_point.vout as usize].value)
                .ok_or(Error::UnmatchedInput(out_point.clone()))
        });
        assert_eq!(get_fee_result.is_ok(), true);
        assert_eq!(get_fee_result.unwrap(), fee);
    }
