...
/// A "parsed opcode" which allows iterating over a [`ScriptBuf`] in a more sensible way.
...
///
/// The returned indices can be used for slicing [`ScriptBuf`] [safely](ScriptBuf#slicing-safety).
///
