...
use crate::{PubkeyHash, WPubkeyHash};
...
impl ScriptBuf {
    ...
    /// # Panics
    ///
    /// - If program length is invalid (less than 2 bytes or greater than 40 bytes).
    /// - If witness version is v0 and program length is not either 20 or 32 bytes.
