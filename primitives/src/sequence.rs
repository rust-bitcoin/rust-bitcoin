...
impl Sequence {
    ...
    pub fn to_relative_lock_time(self) -> Option<relative::LockTime> {
        use crate::locktime::relative::{LockTime, MtpInterval, NumberOfBlocks};
...
impl<'a> Arbitrary<'a> for Sequence {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        ...
        match choice {
            ...
            4 =>
                Ok(Sequence::from_consensus(u32::from(relative::NumberOfBlocks::MIN.to_interval()))),
            5 =>
                Ok(Sequence::from_consensus(u32::from(relative::NumberOfBlocks::MAX.to_interval()))),
