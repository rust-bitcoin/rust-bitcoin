...
//! use bitcoin_primitives::{consensus, Block, MerkleBlock, Txid};
//!
...
//! let mb: MerkleBlock = consensus::deserialize(&mb_bytes).unwrap();
//!
...
use crate::block::{self, Block, TxMerkleNode};
...
impl PartialMerkleTree {
    ...
    /// use bitcoin_primitives::merkle_tree::{MerkleBlock, PartialMerkleTree};
    ///
    /// // Block 80000
    /// let txids: Vec<Txid> = [
