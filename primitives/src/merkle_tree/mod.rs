...
//! # use bitcoin_primitives::merkle_tree::{MerkleNode as _, TxMerkleNode};
//! # use bitcoin_primitives::hashes::Hash;
...
mod tests {
    ...
    fn static_vector() {
        ...
        let segwit_block = include_bytes!("../../../bitcoin/tests/data/testnet_block_000000000000045e0b1660b6445b5e5c5ab63c9a4f956be7e1e69be04fa4497b.raw");
