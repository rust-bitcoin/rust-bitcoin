...
#[cfg(feature = "crypto")]
use super::{DecodeError, TAPROOT_CONTROL_NODE_SIZE};
use super::{InvalidMerkleTreeDepthError, TapNodeHash, TAPROOT_CONTROL_MAX_NODE_COUNT};
use crate::prelude::*;
...
impl TaprootMerkleBranch {
    ...
    #[cfg(feature = "crypto")]
    pub fn decode(sl: &[u8]) -> Result<Self, DecodeError> {
        if sl.len() % TAPROOT_CONTROL_NODE_SIZE != 0 {
            Err(DecodeError::InvalidMerkleBranchSize(sl.len()))
