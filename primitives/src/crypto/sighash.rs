...
impl<E> EncodeSigningDataResult<E> {
    ...
    ///
    /// ```rust
    /// # use bitcoin_primitives::consensus::deserialize;
    /// # use bitcoin_primitives::hashes::{Hash, hex::FromHex};
    /// # use bitcoin_primitives::sighash::{LegacySighash, SighashCache};
    /// # use bitcoin_primitives::Transaction;
    /// # let mut writer = LegacySighash::engine();
    /// # let input_index = 0;
    /// # let script_pubkey = bitcoin_primitives::ScriptBuf::new();
