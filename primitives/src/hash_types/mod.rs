...
#[cfg(feature = "hex")]
macro_rules! impl_hashtype_fmt_traits {
    ($ty:ident) => {
...
#[cfg(feature = "hex")]
pub(in crate::hash_types) use impl_hashtype_fmt_traits;

#[cfg(not(feature = "hex"))]
macro_rules! impl_hashtype_debug {
    ($ty:ident) => {
...
#[cfg(not(feature = "hex"))]
pub(in crate::hash_types) use impl_hashtype_debug;
