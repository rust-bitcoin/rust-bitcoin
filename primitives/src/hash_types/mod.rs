...
pub use self::{
    ...
    ntxid::Ntxid,
    transaction_merkle_node::TxMerkleNode,
    txid::Txid,
    wtxid::Wtxid,
...
#[doc(inline)]
pub use self::{
    script_hash::{ScriptHash, RedeemScriptSizeError},
...
pub(crate) use impl_bytelike_traits;
...
// FIXME: Restrict this to just this module.
#[cfg(feature = "serde")]
...
mod tests {
    ...
    fn debug() {
        ...
        // let want = "Txid(abababababababababababababababababababababababababababababababab)";
    ...
    // TODO: Test Debug with a non-repeating string so we explicitly see `REVERSE`.
    // TODO: Roundtrip: Display/FromStr, to/from_byte_array.
    // TDOO: Regression test Display (with a non-repeating string so we explicitly see `REVERSE`).
}
