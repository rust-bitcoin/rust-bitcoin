...
include!(concat!(env!("CARGO_MANIFEST_DIR"), "/../include/decoder_newtype.rs")); // decoder_newtype! macro
#[cfg(feature = "alloc")]
include!(concat!(env!("CARGO_MANIFEST_DIR"), "/../include/asref_push_bytes.rs")); // impl_asref_push_bytes! macro
