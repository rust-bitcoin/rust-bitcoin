...
use encoding::{self, Encodable};
#[cfg(feature = "alloc")]
use encoding::{Decodable, Decoder, Decoder6};
...
impl fmt::Display for HeaderDecoderError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            Self::Version(ref e) => write_err!(f, "transaction decoder error"; e),
            Self::PrevBlockhash(ref e) => write_err!(f, "transaction decoder error"; e),
            Self::MerkleRoot(ref e) => write_err!(f, "transaction decoder error"; e),
            Self::Time(ref e) => write_err!(f, "transaction decoder error"; e),
            Self::Bits(ref e) => write_err!(f, "transaction decoder error"; e),
            Self::Nonce(ref e) => write_err!(f, "transaction decoder error"; e),
        }
    }
}
