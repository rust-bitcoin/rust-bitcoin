...
use crate::{BlockTime, BlockTimeDecoder, BlockTimeDecoderError, CompactTarget, TxMerkleNode};
#[cfg(feature = "alloc")]
...
#[cfg(feature = "hex")]
pub struct ParseHeaderError(crate::hex_codec::ParsePrimitiveError<Header>);
