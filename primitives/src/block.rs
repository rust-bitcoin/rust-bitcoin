...
// Its consuming to have two block modules so re-export these from here.
#[rustfmt::skip]                // Keep public re-exports separate.
#[doc(inline)]
pub use units::block::{BlockHeight, BlockInterval};
...
mod tests {
    ...
    fn segwit_block_test() {
        ...
        let segwit_block = include_bytes!("../../bitcoin/tests/data/testnet_block_000000000000045e0b1660b6445b5e5c5ab63c9a4f956be7e1e69be04fa4497b.raw").to_vec();
...
mod benches {
    ...
    pub fn bench_stream_reader(bh: &mut Bencher) {
        let big_block = include_bytes!("../../bitcoin/tests/data/mainnet_block_000000000000000000000c835b2adcaedc20fdf6ee440009c249452c726dafae.raw");
