...
/// # Panics
///
/// Panics if internal arithmetic overflow occurs during decoding (should never happen with valid input).
...
/// # Panics
///
/// Panics if the internal string formatting fails (should never happen in practice).
