...
/// Implements hex-based string-ish traits for byte-based newtypes.
///
...
#[macro_export]
macro_rules! impl_array_newtype_hex {
    ($t:ident, $len:literal) => {
        impl $t {
...
/// Implements serde traits for byte-based newtypes.
#[macro_export]
macro_rules! impl_array_newtype_serde {
    ($t:ident, $len:literal) => {
        #[cfg(feature = "serde")]
