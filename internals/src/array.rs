...
pub trait ArrayExt {
    ...
    ///
    /// This is almost equivalent to just calling [`sub_array`] twice, except it also checks that
    /// the arrays don't overlap and that they cover the full range. This is very useful for
    /// demonstrating correctness, especially when chained. It also already found a bug.
