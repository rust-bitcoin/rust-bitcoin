...
#[cfg(feature = "hex")]
use crate::parse::{self, PrefixedHexError, ParseIntError, UnprefixedHexError};
...
impl Target {
    ...
    fn from_compact(c: CompactTarget) -> Target {
...
mod tests {
    ...
    use super::*;
    use crate::pow::test_utils::u64_to_target;
    ...
    fn compact_target_lower_hex_and_upper_hex() {
        assert_eq!(alloc::format!("{:08x}", CompactTarget::from_consensus(0x01D0F456)), "01d0f456");
        assert_eq!(alloc::format!("{:08X}", CompactTarget::from_consensus(0x01d0f456)), "01D0F456");
    }
