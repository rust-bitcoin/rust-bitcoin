...
impl Target {
    ...
    ///
    /// The return value should be checked against a network's `max_attainable_target` or use one of
...
impl Mul for Target {
    type Output = Self;
    fn mul(self, rhs: Self) -> Self { Self(self.0.mul(rhs.0)) }
}

impl Div for Target {
    type Output = Self;
    fn div(self, rhs: Self) -> Self { Self(self.0.div(rhs.0)) }
}
...
mod tests {
    ...
    fn target_difficulty_with_max() {
        let targets = [
            ...
            (Target::MAX_ATTAINABLE_MAINNET / u64_to_target(10), 10),
            (Target::MAX_ATTAINABLE_TESTNET / u64_to_target(0x9234_0000_u64), 2_452_881_408),
            (Target::MAX_ATTAINABLE_SIGNET / u64_to_target(0x1234_5600_u64), 344_060),
            (Target::MAX_ATTAINABLE_REGTEST / u64_to_target(0xffff_ffff_ffff_u64), 131_070),
    ...
    fn target_difficulty_float_with_max() {
        let targets = [
            (Target::MAX_ATTAINABLE_MAINNET / u64_to_target(10), 10.0),
            (Target::MAX_ATTAINABLE_TESTNET / u64_to_target(0x9234_0000_u64), 2_452_881_408.0),
            (Target::MAX_ATTAINABLE_SIGNET / u64_to_target(0x1234_5600_u64), 344_060.0),
            (Target::MAX_ATTAINABLE_REGTEST / u64_to_target(0xffff_ffff_ffff_u64), 131_070.0),
