...
* Move crate from [original repo](https://github.com/rust-bitcoin/dashcore_hashes) to the
`rust-bitcoin` repository. Commit history was lost during move, for commit history see the original
repository. Tip of dashcore_hashes:master at time of import: 54c16249e06cc6b7870c7fc07d90f489d82647c7
...
* [Enable edition 2018 and bump MSRV to Rust 1.41.1](https://github.com/rust-bitcoin/dashcore_hashes/pull/136)

## New features/APIs

* [Add `all_zeros` to `Hash` trait](https://github.com/rust-bitcoin/dashcore_hashes/pull/148)
* [Implement `Write` on `HmacEngine`](https://github.com/rust-bitcoin/dashcore_hashes/pull/133)
* [Introduce `HexWriter`](https://github.com/rust-bitcoin/dashcore_hashes/pull/156), makes serialising hex faster
* [Implement `Read` on `HexIterator`](https://github.com/rust-bitcoin/dashcore_hashes/pull/135), makes deserialising hex faster

## Other improvements

* Use `rotate_left` [instead of custom macro](https://github.com/rust-bitcoin/dashcore_hashes/pull/162)
* [Enable clippy on CI](https://github.com/rust-bitcoin/dashcore_hashes/pull/152)
* Various docs fixes
* [Improve feature test coverage](https://github.com/rust-bitcoin/dashcore_hashes/pull/147)
* [Add a disabled `rustfmt.toml`](https://github.com/rust-bitcoin/dashcore_hashes/pull/141) to improve interaction with auto-formatting in editors
...
* Add [`#[repr(transparent)]` to all newtype wrappers](https://github.com/rust-bitcoin/dashcore_hashes/pull/108/)
* Add [missing `#derive`s](https://github.com/rust-bitcoin/dashcore_hashes/pull/110/)
* Replace `fuzztarget` feature with [use of `cfg(fuzzing)`](https://github.com/rust-bitcoin/dashcore_hashes/pull/111/)
* Use [`core` rather than `std`](https://github.com/rust-bitcoin/dashcore_hashes/pull/118/) and [fix `no_std` compilation](https://github.com/rust-bitcoin/dashcore_hashes/pull/122/)
...
* [Add `from_inner` method](https://github.com/rust-bitcoin/dashcore_hashes/pull/20) to all hashes
* [Update `FromHex` trait](https://github.com/rust-bitcoin/dashcore_hashes/pull/40) to require `from_byte_iter` method rather than `from_hex` be implemented
* Make `Hmac` midstate [an actual HMAC midstate](https://github.com/rust-bitcoin/dashcore_hashes/pull/43)
* Allow `Display` [of truncated hashes](https://github.com/rust-bitcoin/dashcore_hashes/pull/9)
* Require [using a constructor for `HexIterator`](https://github.com/rust-bitcoin/dashcore_hashes/pull/44) and then [clean up the internals](https://github.com/rust-bitcoin/dashcore_hashes/pull/47)
* [Strongly type `sha256::Midstate`](https://github.com/rust-bitcoin/dashcore_hashes/pull/39) to allow independent serialization
* Add [siphash24 module](https://github.com/rust-bitcoin/dashcore_hashes/pull/46)

# 0.3.2 - 2019-03-20

* Implement the `FromHex` trait on [many more types](https://github.com/rust-bitcoin/dashcore_hashes/pull/38)

# 0.3.1 - 2019-03-04

* [Fix serde serialization](https://github.com/rust-bitcoin/dashcore_hashes/pull/36)
