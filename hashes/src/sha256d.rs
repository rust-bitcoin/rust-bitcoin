...
//! SHA-256d implementation (double SHA-256).

use crate::{sha256, FromSliceError, HashEngine};

/// Length of digest created by SHA-256d hash algorithm, in bytes.
...
/// Output of the SHA-256d hash function.
...
impl Hash {
    ...
    pub const fn all_zeros() -> Self { Self([0x00; 32]) }
}
