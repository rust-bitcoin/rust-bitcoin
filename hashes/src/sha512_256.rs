...
/// Length of digest created by SHA-512/256 hash algorithm, in bytes.
...
impl Engine {
    /// Creates a new SHA-512-256 hash engine.
    pub const fn new() -> Self { Self(sha512::Engine::sha512_256()) }
}
