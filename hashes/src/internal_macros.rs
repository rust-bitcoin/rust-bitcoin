...
macro_rules! hash_type {
    ($bytes:expr, $doc:literal) => {
        ...
        impl Hash {
            ...
            pub const fn from_byte_array(bytes: [u8; $bytes]) -> Self { Self(bytes) }
            ...
            pub const fn all_zeros() -> Self { Self([0x00; $bytes]) }
        }
        ...
        impl schemars::JsonSchema for Hash {
            ...
            fn json_schema(gen: &mut schemars::gen::SchemaGenerator) -> schemars::schema::Schema {
                ...
                schema.string = Some(Box::new(schemars::schema::StringValidation {
                    max_length: Some(len as u32 * 2), // Cast ok, N is digest size (ie, only ever small).
                    min_length: Some(len as u32 * 2),
