...
work under it, because each one is handed the same hash implementation its target verifies
with. Drop the flag and the checksummed targets keep working just as well.
